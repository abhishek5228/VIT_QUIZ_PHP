...
<style id="global-dark-mode" media="screen">html:before {
  ...
  }</style></head><style id="global-dark-mode" media="screen">html:before {
    content: " ";
    z-index: 100000000000000;
    pointer-events: none;
    position: fixed;
...
<div id="page_outline">
	...
	<section>
		<div class="btn-group-vertical dropright">
				...
				<li><a href="result.php" id="EXM0011" class="btnItem" onclick="toggleButtonMenuItem()"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i class="fa fa-dot-circle-o"></i>&nbsp;&nbsp;Marks</a></li>
...
<div id="page-wrapper" class="col-md-12 content-center">
							...
							<ul class="news-slice">
								<li class="text-primary news_card_text">
									<p>
											...
											<a target="_blank" href="javascript:void(0);" onclick="javascript:vtopDownload('downloadSpotLightViewFile/346');">Code of conduct related to Continuous Assessment Test (Winter Semester 2020-21)</a>									
						...
						<ul class="news-slice">
							<li class="text-primary news_card_text">
								<p>
										...
										<a target="_blank" href="javascript:void(0);" onclick="javascript:vtopDownload('downloadSpotLightViewFile/359');">Regular Arrear Examinations June 2021 (Timed out Students, Present Final year Students * ) - Registration for Failed courses with 'F' and 'N' grades  - Approved Re-FATs - Registration </a>									
						...
						<ul class="news-slice">
							<li class="text-primary news_card_text">
								<p>
										...
										<a target="_blank" href="javascript:void(0);" onclick="javascript:vtopDownload('downloadSpotLightViewFile/323');">Mobile Only File Upload - Codetantra Proctored Exam - Students - VIT</a>									
						...
						<ul class="news-slice">
							<li class="text-primary news_card_text">
								<p>
										...
										<a target="_blank" href="javascript:void(0);" onclick="javascript:vtopDownload('downloadSpotLightViewFile/321');">Laptop + Mobile - Codetantra Proctored Exam - Students - VIT</a>									
		...
		<div class="modal fade" id="researchModal" role="dialog">
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">×</button>
		        <h4 class="modal-title" style="color:red;">RESEARCH</h4>
		      </div>
		      <div class="modal-body">
		...
		<div class="modal fade" id="sprModal" role="dialog">
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      <div class="modal-header">
		        <button type="button" class="close" data-dismiss="modal">×</button>
		        <h4 class="modal-title" style="color:red;">SPONSORED RESEARCH</h4>
		      </div>
		      <div class="modal-body">
		  ...
		  <div class="modal-dialog">
			...
			<div class="box box-info">
				<div class="box-header">
							<h4 class="box-title text-center" style="font-weight: bold; height: 12px;">Spotlight</h4>
				</div>
				...
				<div class="box-body">
					...
					<hr>	
						...
						<button class="btn btn-primary btn-sm" onclick="openModal('acad')" type="button">Academics&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge">1</span></button>
						...
						<button class="btn btn-primary btn-sm" onclick="openModal('coe')" type="button">COE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-secondary">3</span></button>
			...
			<script>
				function  openModal(mType) {
					if(mType=='acad') {
						$("#academicsModal").modal();
					}else if(mType=='events') {
						$("#eventsModal").modal();
					}else if(mType=='coe') {
						$("#coeModal").modal();
					}
					else if(mType=='others') {
						$("#othersModal").modal();
					} 
					else if(mType=='sprnsresh') {
						$("#sprModal").modal();
					} 
					else if(mType=='research') {
						$("#researchModal").modal();
					} 
