						...
						<ul class="news-slice">
							<li class="text-primary news_card_text">
								<p>
										...
										<a target="_blank" href="javascript:void(0);" onclick="javascript:vtopDownload('downloadSpotLightViewFile/325');">FAT - CODE OF CONDUCT FOR STUDENTS</a>									
			...
			<div class="box box-info">
				...
				<div class="box-body">
					...
					<hr>	
						...
						<button class="btn btn-primary btn-sm" onclick="openModal('others')" type="button">Others&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge badge-secondary">1</span></button>
