...
<div id="page_outline">
	...
	<section>
            ...
            <div class="col-sm-8">
                <h1>ADD QUESTION
					...
					if(isset($_GET['msg'])&&!empty($_GET['msg']))
					{
						...
						echo"<p>Question added succesfuly</p>";
					}	
					?>
          
                <form action="add_quiz.php" method="post" id="form1">
                   
                    <div class="form-group">
                          <label for="text">Question</label>
                                      <input type="text" class="form-control" id="email" placeholder="Enter Question" name="qus">
                    </div>
					
					
                    <div class="form-group">
                          <label for="text">Option-1</label>
                                      <input type="text" class="form-control" id="email" placeholder="Enter Option-1 " name="op1">
                    </div>
					
					
                    <div class="form-group">
                          <label for="text">Option-2</label>
                                      <input type="text" class="form-control" id="email" placeholder="Enter Option-2" name="op2">
                    </div>
					
					
                    <div class="form-group">
                          <label for="text">Option-3</label>
                                      <input type="text" class="form-control" id="email" placeholder="Enter Option-3" name="op3">
                    </div>
					
					
                    <div class="form-group">
                          <label for="text">Option-4</label>
                                      <input type="text" class="form-control" id="email" placeholder="Enter Option-4" name="op4">
                    </div>
					<div class="form-group">
                          <label for="text">Answer</label>
                                      <input type="text" class="form-control" id="email" placeholder="Enter Answer" name="ans">
                    </div>
	  ...
	  <label class="control-label col-sm-0" for="pwd">Select Category</label>
	  ...
	  <option disabled>Select Category</option>
                            <?php
                                    ...
                                    {?>
                                     <option><?php echo $category['cat_name'];
									 ?></option>  
                                    <?php } ?>
