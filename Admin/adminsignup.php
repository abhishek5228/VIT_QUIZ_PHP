				...
				<section id="loginbox" class="col-md-4 col-md-offset-4">
					...
					<div class="box box-info">
						...
						<div class="box-header with-border">
							<h3 class="box-title">VTOP Sign-Up</h3>
						</div>
						...
						<?php
                            ...
                            ?>
								<form class="form-signin" id="form-signin_v1" action="adminsignup_sub.php" method="POST" autocomplete="off">
								...
								<input type="text" class="form-control" id="user" placeholder="Enter Your Name" name="u" required >
								...
								<input type="text" class="form-control" id="email" placeholder="Enter V-TOP Registration E-Mail" name="e" required>
									 </span>
								</div>
								...
								<div class="box-footer">
	                       		...
	                       		<p>Already have an account?<a href="vitlogin.php">Login</p></a>	
									</div>
								...
								<div>	
									...
									<div class="row col-xs-6">
										<button id="captcha" class="btn btn-primary pull-right">SignUp</button>
									</div>	
